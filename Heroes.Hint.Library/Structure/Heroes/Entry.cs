...
namespace Heroes.Hint.Library.Structure.Heroes
{
    [StructLayout(LayoutKind.Sequential, Size = 12)]
    public struct Entry
    {
        public static Entry Null = new Entry(0, Character.Sonic, 0, 0, 0);
        ...
        public Entry(short hintNumber, Character character, int offset, short showDuration, short nextHint)
        {
